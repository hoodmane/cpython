...
SETUP_LOCAL_FILE = WASM_DIR / "Setup.local.emscripten"
PRE_JS = WASM_DIR / "emscripten_pre.js"
...
def call(command, *, quiet, **kwargs):
    ...
    if not quiet:
        ...
        stdout = tempfile.NamedTemporaryFile(
            "w", encoding="utf-8", delete=False, prefix="cpython-emscripten-", suffix=".log"
        )
...
def configure_emscripten_python(context, working_dir):
    ...
    sysconfig_data = f"{emscripten_build_dir}/build/lib.emscripten-wasm32-{python_version}"
    if pydebug:
...
def main():
    ...
    configure_host = subcommands.add_parser(
        ...
        "host/emscripten (pydebug builds "
