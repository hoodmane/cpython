...
struct _Py_global_strings {
    ...
    struct {
        ...
        STRUCT_FOR_ID(False)
        STRUCT_FOR_ID(ItemsView)
        STRUCT_FOR_ID(JSONDecodeError)
        STRUCT_FOR_ID(KeysView)
        STRUCT_FOR_ID(MutableMapping)
        STRUCT_FOR_ID(PENDING)
        STRUCT_FOR_ID(Py_Repr)
        STRUCT_FOR_ID(TextIOWrapper)
        STRUCT_FOR_ID(True)
        STRUCT_FOR_ID(ValuesView)
        ...
        STRUCT_FOR_ID(create_pyproxies)
        STRUCT_FOR_ID(ctx)
        STRUCT_FOR_ID(cwd)
